...
public interface IProdutoService
{
    ...
    Task CreateAsync(string codigo, ProdutoCreateUpdateDto dto, string usuarioEmail, string? usuarioMicrosoftId, string? usuarioNome, CancellationToken ct);
    Task UpdateAsync(string codigo, ProdutoCreateUpdateDto dto, string usuarioEmail, string? usuarioMicrosoftId, string? usuarioNome, CancellationToken ct);
