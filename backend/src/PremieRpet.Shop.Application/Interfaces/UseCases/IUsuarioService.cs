...
public interface IUsuarioService
{
    ...
    Task<UsuarioDto> UpsertAsync(string email, string? cpf, string? nome, IEnumerable<string>? roles, bool semLimite, int condicaoPagamento, CancellationToken ct);
    Task<UsuarioDto> CriarLocalAsync(string cpf, string senha, IEnumerable<string>? roles, string? email, string? nome, bool semLimite, int condicaoPagamento, CancellationToken ct);
    ...
    Task<UsuarioDto> AtualizarLocalAsync(Guid usuarioId, string email, string? cpf, string? nome, IEnumerable<string>? roles, bool semLimite, int condicaoPagamento, CancellationToken ct);
